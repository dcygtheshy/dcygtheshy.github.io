...
export const navBarConfig: NavBarConfig = {
	links: [
		...
		{
			name: "GitHub",
			url: "https://github.com/dcygtheshy", // Internal links should not include the base path, as it is automatically added
	...
	links: [
		{
			...
			url: "https://github.com/dcygtheshy",
		},
		{
			name: "Email",
			icon: "fa6-regular:envelope",
			url: "mailto:1633960501@qq.com",
		},
		{
			name: "RSS",
			icon: "fa6-solid:rss",
